!function (a) {
  ...
  e.prototype = {
    init: function () {
      ...
      a.isShow || (this.homePage = this.endPage = ""), 1 === c && (this.homePage = this.prevPage = ""), c === b && (this.endPage = this.nextPage = ""), 1 === b && (this.homePage = this.prevPage = this.endPage = this.nextPage = "")
        //, 1 >= b && (this.isRender = !1)
      ...
      return d + '<input type="text" style="height:29px;width:50px;margin-top: -4px;border: 1px solid #c5b7b7;text-align: center;" placeholder="页码" /><a class="ui-pagination-page-btn" href="javascript:void(0);">跳转</a>'
